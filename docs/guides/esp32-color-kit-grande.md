...
| The display shows text but now icons  | This probably means that the filesystem upload was not succesful, as the icons are load from there. Make sure that you have followed [this step](/guides/esp32-color-kit-grande/#upload-the-file-system-to-device) ![../img/guides/color-kit-grande/trouble2_ckg_no_icons.jpeg](../img/guides/color-kit-grande/trouble2_ckg_no_icons.jpeg) |
